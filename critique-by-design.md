...
|What is confusing or what don't you like about this graph?|The percentages don't mean much without more context|
|Other thoughts?||
...
|----------|-------------|
|What do you think this graph is trying to show you?|             |
|What is confusing or what don't you like about this graph?|Having the percentages on the blocks instead of numbers would be more intuitive, since they represent parts of a whole|
|          |             |
...
## AI Acknowledgements
AI was used briefly to help me with some more advanced Tableau features as I experimented (e.g., adding a reference line to the bar chart), but ultimately none of the final results made it to this page because I found that they added too much complexity.
